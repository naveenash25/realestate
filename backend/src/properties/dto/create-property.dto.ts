...
export enum LocationTier { METRO = 'metro', TIER1 = 'tier1', NONTIER = 'nontier' }
export enum PropertyType { PLOT = 'plot', FLAT = 'flat', VILLA_SIMPLEX = 'villa_simplex', VILLA_DUPLEX = 'villa_duplex', VILLA_TRIPLEX = 'villa_triplex', RESORT = 'resort' }
export enum ReraStatus { APPROVED = 'approved', NON_APPROVED = 'non_approved', PRE_LAUNCH = 'pre_launch' }
